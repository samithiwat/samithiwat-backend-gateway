    ...
    "paths": {
        ...
        "/blog/user": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "BUser dto",
                        "name": "BUser",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.BlogUserDto"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/proto.BlogUser"
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/proto.BookmarkResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid ID",
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/proto.BookmarkStatusResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid ID",
